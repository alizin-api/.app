...
// Random Key
randomapikeys = ["free","9286c1a775","9267ic6a0f1","927j59de9c","921n567ea6","921h5a4282","925n2c494","928b0323c9","927b0k3hp7o2","925b04ib0j","023l1qhbpk","92b1a0h7ts","92a70b789c","9291a7bk0p1","92a7o8pe9c","92y1a7l0a6","9221a7i9h2","921a7k3n94","92a0kk2bc9","921a7l9pho2","92a2n1kb0j","92b0a75k6f","92u1a7pr8s"];
const randomkeys = randomapikeys[Math.floor(Math.random() * (randomapikeys.length))]

// List Key
listkey = ["free","9286c1a775","9267ic6a0f1","927j59de9c","921n567ea6","921h5a4282","925n2c494","928b0323c9","927b0k3hp7o2","925b04ib0j","023l1qhbpk","92b1a0h7ts","92a70b789c","9291a7bk0p1","92a7o8pe9c","92y1a7l0a6","9221a7i9h2","921a7k3n94","92a0kk2bc9","921a7l9pho2","92a2n1kb0j","92b0a75k6f","92u1a7pr8s"];

// List Key Prem
listkeyprem = ["alizin-apii"];

// List Key Vip
listkeyvip = ["alizin-apik"];
...
mess = {
    error: {
        status: false,
        code: 503,
        MENSAGEM: 'Error, serviço em manutenção',
        CRIADOR: `${author}`
    },
    noturl: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Error, url inválida',
    	CRIADOR: `${author}`
    },
    nottext: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Error, texto inválido',
    	CRIADOR: `${author}`
    },
    nottext1: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Error, texto 1 inválido',
    	CRIADOR: `${author}`
    },
    nottext2: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Error, texto 2 inválido',
    	CRIADOR: `${author}`
    },
    notnum: {
    	status: false,
    ...
    notpage: {
    	status: false,
    	MENSAGEM: 'Entrar na página',
    	CRIADOR: `${author}`
    },
    notmoji1: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Erro, Emoji 1 inválido',
    	CRIADOR: `${author}`
    },
    notmoji2: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Erro, Emoji 2 inválido',
    	CRIADOR: `${author}`
    },
    notquery: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Erro, consulta inválida',
    	CRIADOR: `${author}`
    },
    notapikey: {
    	status: false,
    	code: 403,
    	MENSAGEM: `Erro, sem parâmetros de apikey, insira: apikey=SUA_APIKEY, não tem apikey? verifique no painel para obter o apikey.`,
    	CRIADOR: `${author}`
    },
    notapikeyprem: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Erro, Apikey inválido, você não é um usuário premium, preço de compra',
    	CRIADOR: `${author}`
    },
    notapikeyvip: {
    	status: false,
    ...
    notid: {
    	status: false,
    	code: 404,
    	MENSAGEM: 'Erro, ID ou nome de usuário inválido',
    	CRIADOR: `${author}`
    },
    ready: {
    	status: false,
    	code: 403,
    	MENSAGEM: 'Erro, já em uso',
    	CRIADOR: `${author}`
    }
  }
